...
#PROGRAMA QUE MUESTRA LOS AÑOS QUE HAN TRANSCURRIDO O LO QUE FALTAN, A PARTIR DEL AÑO ACTUAL Y EXAMINA SI LOS AÑOS SON IGUALES O NO
...
class Desk:
    def __init__(self, window):
        ...
        frame = LabelFrame(self.wind, text = 'CALCULAR AÑOS')
